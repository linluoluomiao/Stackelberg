...
- Zhang, X.; Wang, Z.; Tian, F.; Yang, Z. Stackelberg-Game-Based Multi-User Multi-Task Offloading in Mobile Edge Computing. IEEE Transactions on Cloud Computing 2024, 12 (2), 459–475. `https://doi.org/10.1109/tcc.2024.3370909.`

## 10. 课程论文

本项目的课程论文位于：`基于Stackelberg博弈的多用户多任务卸载算法论文.md`

## 11. 注意事项

- 代码中的价格单位为$/CPU cycle，实际应用中可根据需要调整
- 系统参数可通过修改`initialize_parameters`方法进行调整
- 可视化结果可通过调整`Visualizer`类中的参数进行美化
- 对于大规模系统，可考虑优化算法效率
